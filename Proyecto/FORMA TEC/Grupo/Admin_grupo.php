...
<?php
  ...
  verificar_permisos_usuarios('grupo');
?>
<!DOCTYPE html>
...
<body>
  ...
  <div id="cont" class="contenedor" style="height:auto;">
    <div class="panel panel-primary" style="height: 100%;">
      <div class="panel-heading"><p style="text-align:center;font-size: 20px;"><strong>Administración de Grupos</strong></p></div>
      <div class="panel-body">
        ...
        <div id="opcion">
          <p style="text-align: center;"><i class="fas fa-layer-group" style="font-size:200px;"></i></p>
          <br>
          ...
          <form method="post" onsubmit="return false" action="return false">
            ...
            <table class="tabla_formulario">
              <tr>
                <td>Horario: </td>
                <td>
                  <input type="text" class="form-control" id="horario" name="horario" size="40">
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  ...
                  while ($fila = mysqli_fetch_array($result)) {
                    echo "<option>" . $fila['nombres_docente'].' '.$fila['apellidos_docente'] . "</option>";
                  }
                  echo "</select>";
