...
<body>
  ...
  <div id="cont" class="contenedor" style="height:auto;">
    <div class="panel panel-primary" style="height: 100%;">
      <div class="panel-heading"><p style="text-align:center;font-size: 20px;"><strong>Administración de Docentes</strong></p></div>
      <div class="panel-body">
        ...
        <div id="opcion">
          <p style="text-align: center;"><i class="fas fa-chalkboard-teacher" style="font-size:200px;"></i></p>
          <br>
          ...
          <form method="post" onsubmit="return false" action="return false">
            ...
            <table class="tabla_formulario">
              <tr>
                <td>Nombres: </td>
                <td>
                  <input type="text" class="form-control" id="nombres" name="nombres" size="40">
                </td>
              </tr>
              <tr>
                <td>Apellidos:</td>
